...
* 08:00 ~ 09:00 : Hello Papang 개발
  * 사용자 관리 - 게스트 제약 사항 <span style = "color:blue">(완료)</span>
  * 요청기록조회 - 기타 유형 조회 오류 수정 <span style = "color:blue">(완료)</span>
...
* Hello Papang 개발
  ...
  * 문서화 작업(요구사항 명세서, 테이블 명세서) <span style = "color:blue">(완료)</span>
  * 사용자 관리 - 게스트 제약 사항
  * 요청기록조회 - 기타 유형 조회 오류 수정
  * 관리자 홈
  * 비밀번호 변경
* 다이어트(4/7)
  * 간식 먹지 않기
